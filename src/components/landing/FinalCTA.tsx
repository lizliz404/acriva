  ...
  return (
    <section id="pricing" className="border-t border-[#E8DFD0]">
      <div className="container-page py-14 md:py-16">
        ...
        >
          <p className="mb-2 text-[14px] font-medium text-[#4A433A]">{t.finalCta.note}</p>
      ...
      <div className="border-t border-[#E8DFD0] bg-[#1C1712] py-20 md:py-28">
        <div className="container-page">
          <motion.div {...sectionInView} className="mx-auto max-w-[760px] text-center">
            ...
            <h2 className="text-hero mb-4 !text-[#F7F0E4]">{t.product.tagline}</h2>
            <p className="mb-8 text-[16px] text-[#F7F0E4]/65">{t.product.taglineAlt}</p>
            <div className="flex flex-wrap items-center justify-center gap-3">
              <Link to="/app" className="btn-primary">
                {t.finalCta.enterDesk}
              </Link>
              <Link
                to="/app/market/sell"
